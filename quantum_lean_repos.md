...
2. [OSforGFF](https://github.com/mrdouglasny/OSforGFF). Lean formalization of the Osterwalder-Schrader axioms for Quantum Field Theory, and a particular model (four-dimensional Gaussian Free Field) that satisfies these.
3. [Lean-QuantumInfo](https://github.com/Timeroot/Lean-QuantumInfo). _Archived for the time being._ Focused on finite-dimensional quantum information: channels, entropy, capacities, and a lot of mathematical machinery for more efficiently manipulating Hermitian matrices. Culminated in quantum generalized Stein's Lemma. Now merged into Physlib.
4. [LeanQuantum](https://github.com/inQWIRE/LeanQuantum). Focused on qubits and qubit-gates.Based on the INQWIRE QuantumLib(https://github.com/inQWIRE/QuantumLib) and [SQIR / VOQC](https://github.com/inQWIRE/SQIR) verified quantum compiler in Roqc, although the Lean repo is much smaller.
5. [Lean-QEC](https://github.com/VerifiedQC/Lean-QEC). Companion to [https://arxiv.org/abs/2605.16523](End-to-End Formalization of Quantum Error Correction), coming out of QUICS at UMD.
